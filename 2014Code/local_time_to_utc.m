function dateStringUtc = local_time_to_utc( dateVectorLocal )
%
...
% values will be converted to UTC and returned in 'dd-mmm-yyyy HH:MM:SS' format.
%
...
dateStringUtc = datestr(dateVectorUtc,'yyyy/mm/dd HH:MM:SS') ;
return
% and that's it!
%
%
...
% numbers as we go
dateVectorUtc(iDate,1) = str2double(dateStringUtc(1:4)) ;
dateVectorUtc(iDate,2) = str2double(dateStringUtc(6:7)) ;
dateVectorUtc(iDate,3) = str2double(dateStringUtc(9:10)) ;
dateVectorUtc(iDate,4) = str2double(dateStringUtc(12:13)) ;
dateVectorUtc(iDate,5) = str2double(dateStringUtc(15:16)) ;
dateVectorUtc(iDate,6) = str2double(dateStringUtc(18:19)) ;
end % loop over dates
return
